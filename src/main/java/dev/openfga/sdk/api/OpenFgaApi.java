...
public class OpenFgaApi {
     ...
     */
    public CompletableFuture<ApiResponse<BatchCheckResponse>> batchCheck(String storeId, BatchCheckRequest body)
            throws ApiException, FgaInvalidParameterException {
        return batchCheck(storeId, body, this.configuration);
    }
     ...
     * @throws ApiException if fails to make API call
     */
    public CompletableFuture<ApiResponse<BatchCheckResponse>> batchCheck(
            String storeId, BatchCheckRequest body, ConfigurationOverride configurationOverride)
            throws ApiException, FgaInvalidParameterException {
        return batchCheck(storeId, body, this.configuration.override(configurationOverride));
    }

    private CompletableFuture<ApiResponse<BatchCheckResponse>> batchCheck(
            String storeId, BatchCheckRequest body, Configuration configuration)
            throws ApiException, FgaInvalidParameterException {

        assertParamExists(storeId, "storeId", "batchCheck");
     ...
     * @param pageSize  (optional)
     * @param continuationToken  (optional)
     * @param startTime Start date and time of changes to read. Format: ISO 8601 timestamp (e.g., 2022-01-01T00:00:00Z) If a continuation_token is provided along side start_time, the continuation_token will take precedence over start_time. (optional)
    ...
    public CompletableFuture<ApiResponse<ReadChangesResponse>> readChanges(
            String storeId, String type, Integer pageSize, String continuationToken, OffsetDateTime startTime)
            throws ApiException, FgaInvalidParameterException {
        return readChanges(storeId, type, pageSize, continuationToken, startTime, this.configuration);
    }
