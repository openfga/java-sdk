...
```groovy
implementation 'dev.openfga:openfga-sdk:0.8.2-beta.1'
```
...
```xml
<dependency org="dev.openfga" name="openfga-sdk" rev="0.8.2-beta.1"/>
```

* SBT

```scala
libraryDependencies += "dev.openfga" % "openfga-sdk" % "0.8.2-beta.1"
```

* Leiningen

```edn
[dev.openfga/openfga-sdk "0.8.2-beta.1"]
```
