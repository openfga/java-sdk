...
[![Socket Badge](https://badge.socket.dev/maven/package/dev.openfga:openfga-sdk/0.9.8)](https://socket.dev/maven/package/dev.openfga:openfga-sdk) <!-- x-release-please-version -->
...
```groovy
implementation 'dev.openfga:openfga-sdk:0.9.8'
```
...
<!-- x-release-please-start-version -->
```xml
<dependency org="dev.openfga" name="openfga-sdk" rev="0.9.8"/>
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```scala
libraryDependencies += "dev.openfga" % "openfga-sdk" % "0.9.8"
```
<!-- x-release-please-end -->
