...
[![Socket Badge](https://badge.socket.dev/maven/package/dev.openfga:openfga-sdk/0.9.11)](https://socket.dev/maven/package/dev.openfga:openfga-sdk) <!-- x-release-please-version -->
...
<!-- x-release-please-start-version -->
```xml
<dependency org="dev.openfga" name="openfga-sdk" rev="0.9.11"/>
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```scala
libraryDependencies += "dev.openfga" % "openfga-sdk" % "0.9.11"
```
<!-- x-release-please-end -->
...
<!-- x-release-please-start-version -->
```edn
[dev.openfga/openfga-sdk "0.9.11"]
```
<!-- x-release-please-end -->
